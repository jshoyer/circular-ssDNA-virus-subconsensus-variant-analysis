...
to be in your $PATH.
A few paths to java jar files may need to be updated.
...
Two snpEff job scripts merged into other ones
for second release
(Zenodo record [[https://zenodo.org/record/7542465][7542465]]).
